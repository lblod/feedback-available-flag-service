...
const LPDC_PROCESSING_STATUS_ACCEPTED_URI = env.get('LPDC_PROCESSING_STATUS_ACCEPTED_URI').default('http://lblod.data.gift/concepts/1b3c5e7f-2a4d-4c6e-9f1b-3d5a7c9e2f4b').asString();
const LPDC_PROCESSING_STATUS_DENIED_URI = env.get('LPDC_PROCESSING_STATUS_DENIED_URI').default('http://lblod.data.gift/concepts/caa0b2d0-4bfa-46c8-8ee3-f77d0fdfa655').asString();
